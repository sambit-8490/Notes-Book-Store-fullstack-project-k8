    ...
    async function loginUser() {
        ...
        if (response.data.success) {
            ...
            await swal({
                ...
                text: "Welcome back to NotesWala!",
                icon: "success",
                button: "Let's Go!",
            });
                ...
                <div className='col-lg-6 description-col'>
                    ...
                    <div className='description-content'>
                        <h1 className='main-heading'>
                            Own <span className='highlight-text'>NotesWala</span>
                        </h1>
                    ...
                    <img
                        ...
                        src="https://img.freepik.com/free-vector/kids-reading-concept-illustration_114360-8513.jpg"
                        alt='Reading'
                    />
